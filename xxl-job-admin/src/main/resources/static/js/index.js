...
$(function () {
    ...
    function lineChartInit(data) {
        var option = {
               ...
               legend: {
                   data:[I18n.joblog_status_normal, I18n.joblog_status_error, I18n.joblog_status_warn]
               },
               toolbox: {
                   feature: {
                       /*saveAsImage: {}*/
               ...
               series : [
                   {
                       name:I18n.joblog_status_normal,
                       type:'line',
                       stack: 'Total',
                       areaStyle: {normal: {}},
                       /*data: data.content.triggerDayCountSucList*/
                       data: [.87,.93,.89,.92,.88,.89,.87]
                   },
                   {
                       name:I18n.joblog_status_error,
                       type:'line',
                       stack: 'Total',
                       label: {
                           normal: {
                       ...
                       data: [.02,.03,.01,.01,.02,.01,.02]
                   },
                   {
                       name:I18n.joblog_status_warn,
                       type:'line',
                       stack: 'Total',
                       areaStyle: {normal: {}},
                       /*data: data.content.triggerDayCountRunningList*/
                       data: [.11,.04,.10,.07,.10,.10,.11]
                   }
               ],
    ...
    function pieChartInit(data) {
        var option = {
            title : {
                text: I18n.job_dashboard_rate_monitor ,
                /*subtext: 'subtext',*/
                x:'center'
            },
            tooltip : {
