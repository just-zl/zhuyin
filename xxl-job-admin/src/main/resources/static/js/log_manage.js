$(function() {
    ...
    // init date tables
    var userListTable = $("#log_manage_list").dataTable({
        "deferRender": true,
        "processing" : true,
        "serverSide": true,
        "ajax": {
    ...
    // job operate
    $("#log_manage_list").on('click', '.delete',function() {
    ...
    // update
    $("#log_manage_list").on('click', '.update',function() {
