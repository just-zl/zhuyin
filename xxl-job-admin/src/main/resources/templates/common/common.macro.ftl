...
<#macro commonHeader>
	<header class="main-header">
		<a href="${request.contextPath}/" class="logo">
			<span class="logo-mini"><b>烛阴</b></span>
	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click <#if pageName == "log_list">active</#if>" ><a href="${request.contextPath}/log_list"><i class="fa fa-circle-o text-gray"></i><span>${I18n.log_search}</span></a></li>
                <li class="nav-click <#if pageName == "alarm_record">active</#if>" ><a href="${request.contextPath}/alarm_record"><i class="fa fa-circle-o text-gray"></i><span>${I18n.alarm_record}</span></a></li>
                <li class="nav-click <#if pageName == "log_manage">active</#if>" ><a href="${request.contextPath}/log_manage"><i class="fa fa-circle-o text-purple"></i><span>${I18n.log_manage}</span></a></li>
...
<#macro commonFooter >
	<footer class="main-footer">
        <p style="text-align: right">Powered by <b>软通智慧</b></p>
