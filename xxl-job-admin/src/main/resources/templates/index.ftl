            ...
            <div class="row" style="margin-bottom: 20px;">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-aqua">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">${I18n.job_dashboard_normal_logs}</span>
                            ...
                            <span class="progress-description">${I18n.job_dashboard_normal_logs_tip}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12" >
                    <div class="info-box bg-yellow">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">${I18n.job_dashboard_warn_logs}</span>
                            ...
                            <span class="progress-description">
                                ${I18n.job_dashboard_warn_logs_tip}
                                <#--<#if jobLogCount gt 0>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    <div class="info-box bg-red">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">${I18n.job_dashboard_error_logs}</span>
                            ...
                            <span class="progress-description">${I18n.job_dashboard_error_logs_tip}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border" style="margin-bottom: 20px;">
                            <h1 class="box-title" style="font-size: 24px;">${I18n.job_dashboard_log_report}</h1>
